...
* The [`Link` component](/api/hydrogen/components/framework/link) is used to navigate between routes. Your storefront should use links for navigation, loading a new page, or shifting keyboard focus from one element to another.
