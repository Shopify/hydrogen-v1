...
Hydrogen uses [file-based routing](/docs/tutorials/routing/index.md). Any pages added to the `src/routes` directory will be automatically registered as routes by the app. The following routes are included in the Demo Store template:
