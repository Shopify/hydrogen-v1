...
1. Run the following command:
    ...
    Because you're not passing the [flag to use TypeScript](/docs/tutorials/getting-started/templates.md), the project files are created in JavaScript by default.
...
So far, you've created a Hydrogen storefront that's based off the **Hello World** template. [Hydrogen templates](/docs/tutorials/getting-started/templates.md) are working implementations of Hydrogen storefronts.
...
- Learn how to [fetch data from your storefront](/docs/tutorials/getting-started/tutorial/fetch-data.md).
