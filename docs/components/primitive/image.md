...
| decoding?         | <code>('async' &#124; 'sync' &#124; 'auto')</code>                              | The decoding property of the `HTMLImageElement` interface represents a hint given to the browser on how to decode the image. Defaults to `async` .
