...
| ---------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| defaultSeo | <code>Omit&#60;DefaultPageType, 'url'&#62;</code>                              | The SEO information to render as default on every page of the website. This included the defaults for title, description and title template. The title template is default to the pattern of `%s - ${data.title}` where %s is the title of children components. You can overwrite this pattern using `data.titleTemplate` prop. |
