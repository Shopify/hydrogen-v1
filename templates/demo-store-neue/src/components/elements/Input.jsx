...
export default function Input({type, variant, className = '', ...props}) {
  const variants = {
    ...
    minisearch:
      'bg-transparent text-right focus:border-b border-transparent focus:-mb-px border-0 appearance-none px-0 py-1 focus:ring-transparent placeholder:opacity-20 placeholder:text-inherit',
  };
