...
Choose a [template](/docs/tutorials/getting-started/templates.md) to get started building your Hydrogen storefront:
...
- Follow the [Hydrogen tutorial series](/docs/tutorials/getting-started/tutorial/begin.md) to go from "Hello World" to a fully built out Shopify custom storefront.
