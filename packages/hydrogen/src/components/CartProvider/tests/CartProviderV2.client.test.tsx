...
import {CartProviderV2} from '../CartProviderV2.client.jsx';
...
describe('<CartProviderV2 />', () => {
  ...
  describe('prop `data` does not exist', () => {
    it('renders CartContext.Provider with default cart data and status=uninitialized', () => {
      const wrapper = mount(<CartProviderV2>test</CartProviderV2>);
    ...
    it('allows a query customization', () => {
      ...
      const wrapper = mount(
        <CartProviderV2 cartFragment={cartFragment}>
  ...
  describe('prop `data` exist', () => {
    it('renders CartContext.Provider with cart data and flatten lines', () => {
      const wrapper = mount(
        <CartProviderV2 data={CART_WITH_LINES}>test</CartProviderV2>
      );
    ...
    it('renders CartContext.Provider with status=idle follows by status=updating', () => {
      ...
      mount(
        <CartProviderV2 data={CART_WITH_LINES}>
          <CartContext.Consumer>
            {(cartContext) => {
  ...
  //     const wrapper = mount(
  //       <CartProviderV2 countryCode={mockCountryCode}>
  //         <CartContext.Consumer>
  //           {(cartContext) => {
  //             return (
  //               <button
  ...
  //   const wrapper = mount(
  //     <CartProviderV2 countryCode={serverStateCountryCode}>
  //       <CartContext.Consumer>
  //         {(cartContext) => {
  //           return (
  //             <button
  ...
  //   const wrapper = mount(
  //     <CartProviderV2 customerAccessToken={mockCustomerAccessToken}>
  //       <CartContext.Consumer>
  //         {(cartContext) => {
  //           return (
  //             <button
  ...
  //   const wrapper = mount(
  //     <CartProviderV2 customerAccessToken>
  //       <CartContext.Consumer>
  //         {(cartContext) => {
  //           return (
  //             <button
