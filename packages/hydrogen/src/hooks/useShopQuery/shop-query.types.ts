 ...
 * Refer to https://shopify.dev/api/storefront#status_and_error_codes for more information.
 */
export type StorefrontApiResponseOk<DataGeneric = ObjMap<unknown>> =
  FormattedExecutionResult<DataGeneric, StorefrontApiExtensions>;
 ...
 * Refer to https://shopify.dev/api/storefront#status_and_error_codes for more information.
 */
export type StorefrontApiResponseOkPartial<DataGeneric = ObjMap<unknown>> =
 ...
 * Refer to https://shopify.dev/api/storefront#status_and_error_codes for more information.
 */
export type StorefrontApiResponse<DataGeneric = ObjMap<unknown>> =
 ...
 * Refer to https://shopify.dev/api/storefront#status_and_error_codes for more information.
 */
export type StorefrontApiResponsePartial<DataGeneric = ObjMap<unknown>> =
