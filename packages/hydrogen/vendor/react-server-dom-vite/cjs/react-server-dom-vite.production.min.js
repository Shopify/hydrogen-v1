...
function J(){var a=new TextDecoder;a={_chunks:new Map,readRoot:z,_partialRow:"",_stringDecoder:a};a._fromJSON=I(a);return a}function K(a,b){function c(b){var k=b.value;if(b.done)G(a);else{b=k;k=a._stringDecoder;for(var f=b.indexOf(10);-1<f;){var L=a._partialRow;var u=b.subarray(0,f);u=k.decode(u);H(a,L+u);a._partialRow="";b=b.subarray(f+1);f=b.indexOf(10)}a._partialRow+=k.decode(b,h);return e.read().then(c,d)}}function d(b){E(a,b)}var e=b.getReader();e.read().then(c,d)}
