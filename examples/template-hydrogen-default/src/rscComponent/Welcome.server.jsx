    ...
    <>
      ...
      <div className="text-gray-900 pt-16 rounded-[40px] my-16 px-4 xl:px-12 bg-gradient-to-b from-white -mx-4 xl:-mx-12">
        <div className="text-center mb-16">
          ...
          <div className="my-8 flex flex-col lg:flex-row justify-center items-center gap-8 text-gray-700">
            <DocsButton
        ...
        <div className="space-evenly grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
...
function StorefrontInfo() {
  ...
  return (
    <div className="card--card bg-white p-12 shadow-xl rounded-xl text-gray-900">
...
function TemplateLinks() {
  ...
  return (
    <div className="card--card bg-white p-12 md:p-12 shadow-xl rounded-xl text-gray-900">
      ...
      <ul>
        <li className="mb-4">
          <a
            href={`https://template-default.hydrogen-devs.workers.dev/collections/${firstCollection}`}
        ...
        <li className="mb-4">
          <a
            href={`https://template-default.hydrogen-devs.workers.dev/products/${firstProduct}`}
            className="text-md font-medium text-blue-700 hover:underline"
          >
            Product template
          </a>
        ...
        <li>
          <a
            href="https://template-default.hydrogen-devs.workers.dev/error-page"
            className="text-md font-medium text-blue-700 hover:underline"
          >
            404 template
          </a>
